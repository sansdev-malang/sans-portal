...
<body class="min-h-screen flex flex-col justify-between text-[#0f172a] dark:text-slate-50 transition-colors duration-200 antialiased">
    ...
    <header class="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div class="flex items-center gap-2.5">
            <div class="w-8 h-8 rounded-lg logo-gradient-bg flex items-center justify-center shrink-0 shadow-sm">
                <span class="text-white text-lg font-bold" style="font-family: 'Nasalization Rg', sans-serif; font-weight: 400;">S</span>
            </div>
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto px-6 py-8 flex flex-col items-center justify-center gap-10">
        ...
        <div class="portal-grid">
            ...
            <!-- Card 0: Yayasan -->
            <div class="portal-card bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 border-l-[4px] border-l-emerald-600 dark:border-l-emerald-500 rounded-xl p-6 shadow-sm flex flex-col justify-between">
                <div class="space-y-5">
                    <!-- Icon badge: Emerald container -->
                    <div class="w-12 h-12 rounded-xl bg-[#ecfdf5] dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center">
                        <i data-lucide="building-2" class="w-5.5 h-5.5"></i>
                    </div>
                    <div class="space-y-2">
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-slate-50">Yayasan</h3>
                        <p class="text-[13px] text-slate-500 dark:text-slate-400 leading-relaxed">
                            Pusat manajemen dan kendali kepegawaian (HRD) bagi pengelola seluruh unit SANS School.
                        </p>
                    </div>
                </div>
            ...
            <!-- Card 1: PAUD & TK -->
            <div class="portal-card bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 border-l-[4px] border-l-rose-600 dark:border-l-rose-500 rounded-xl p-6 shadow-sm flex flex-col justify-between">
                <div class="space-y-5">
                    <!-- Icon badge: Rose container -->
                    <div class="w-12 h-12 rounded-xl bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 flex items-center justify-center">
